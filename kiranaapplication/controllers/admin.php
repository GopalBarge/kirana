...
class Admin extends CI_Controller {
	...
	{			
		...
		else 
		{
				...
				$this->form_validation->set_rules('price', 'sell price', 'trim|required|numeric');
                $this->form_validation->set_rules('list_price', 'list price', 'trim|numeric');
                $this->form_validation->set_rules('prod_unit', 'product unit', 'trim|required');
